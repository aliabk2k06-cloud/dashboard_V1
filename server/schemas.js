...
export const bankStatementSchema = z.object({
  ...
  debit_total: z.union([z.number(), z.string()]).transform((val) => Number(val) || 0).optional().default(0),
  credit_total: z.union([z.number(), z.string()]).transform((val) => Number(val) || 0).optional().default(0),
  balance: z.union([z.number(), z.string()]).transform((val) => Number(val) || 0).optional().default(0),
  file_path: z.string().nullable().optional(),
  notes: z.string().optional().default(''),
  fiscal_year: z.union([z.number(), z.string()]).transform((val) => Number(val) || 2026).optional().default(2026),
})
